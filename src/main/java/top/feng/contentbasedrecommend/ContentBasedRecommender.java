 ...
 * 
 */
package top.feng.contentbasedrecommend;

import org.ansj.app.keyword.Keyword;
import org.apache.log4j.Logger;
import top.feng.algorithms.PropGetKit;
import top.feng.algorithms.RecommendAlgorithm;
import top.feng.algorithms.RecommendKit;
import top.feng.model.News;
...
public class ContentBasedRecommender implements RecommendAlgorithm
{
	 ...
	 * @return
	 */
	public static HashMap<Long, Double> sortHashMapByValue(HashMap<Long, Double> oriMap) {
		if (oriMap == null || oriMap.isEmpty()) {
			return null;
		}
